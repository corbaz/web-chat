            ...
            if (message.trim() && !isLoading && !isMagicLoading) {
                try {
                    ...
                    let modelToUse: string =
                        selectedModel || 'llama-3.3-70b-versatile'; // Usar el prop si está disponible, o el valor por defecto
...
${message}`;
                    ...
                    console.log('✅ Respuesta varita mágica recibida:', {
                        ...
                        textoMejorado:
                            response.data.choices[0].message.content.substring(
                                0,
                                150
                            ) + '...',
        ...
        const handlePasteFromClipboard = async () => {
            try {
                ...
                alert(
                    'No se pudo acceder al portapapeles. Verifica los permisos.'
                );
            }
        };
