            ...
            if (!hasAnyKey || modalState.forceShow) {
                ...
                const result = await Swal.fire({
                    ...
                    didOpen: () => {
                        ...
                        const menu =
                            document.getElementById('nm-provider-menu');
                        const labelEl =
                            document.getElementById('nm-provider-label');
                        const arrow =
                            document.getElementById('nm-provider-arrow');
                        ...
                        if (
                            ...
                            options.forEach((opt) => {
                                ...
                                el.addEventListener('click', (e) => {
                                    e.stopPropagation();
                                    const val =
                                        el.dataset.value || PROVIDERS[0].id;
                                    select.value = val;
                                    const p =
                                        PROVIDERS.find((pr) => pr.id === val) ||
                                        PROVIDERS[0];
